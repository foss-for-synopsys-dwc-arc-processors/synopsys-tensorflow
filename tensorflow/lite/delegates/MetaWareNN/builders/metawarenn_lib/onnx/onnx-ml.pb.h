...
inline ::onnx::OperatorStatus FunctionProto::_internal_status() const {
...
inline void FunctionProto::_internal_set_status(::onnx::OperatorStatus value) {
