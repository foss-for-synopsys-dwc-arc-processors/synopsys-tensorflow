...
python3.6 evgencnn  --evss_cfg ev_native --evss_debug 0 --debug_error_log --report_verbose --id 1  --cnn_srcdir $op_path"/evgencnn/cnn_src/"$graph_name --outdir $op_path"/evgencnn/models/"$graph_name --name $graph_name --caffe $prototxt_path --weights $caffe_model_path --images /path/to/cnn_models/caffe_models/images/ImageNet/jpeg --generator host_fixed --pixel_mean 103.94,116.78,123.68 --image_scale 4.335
